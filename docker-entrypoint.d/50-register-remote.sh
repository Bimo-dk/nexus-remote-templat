...
REMOTE_NAME="${REMOTE_NAME:-angularRemote}"
REMOTE_ROUTE="${REMOTE_ROUTE:-angular-remote}"
PUBLIC_URL="${PUBLIC_URL:-http://localhost:8701/remoteEntry.json}"
UPSTREAM_URL="${UPSTREAM_URL:-http://remote-angular:80}"
